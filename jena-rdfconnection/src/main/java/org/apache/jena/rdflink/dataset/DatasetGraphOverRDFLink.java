...
import org.apache.jena.sparql.dataset.DatasetGraphSparql;
import org.apache.jena.sparql.dataset.DsgSparqlExecutor;
    ...
    extends DatasetGraphSparql
{
    ...
    /* package */ DatasetGraphOverRDFLink(Creator<RDFLink> rdfLinkCreator, DsgSparqlExecutor executor, boolean supportsTransactions, boolean supportsTransactionAbort) {
        super(executor);
