...
{
    private static final Logger logger = LoggerFactory.getLogger(TransactionalOverRDFLink.class);
    ...
    public boolean isInTransaction() {
        ...
        if (link != null) {
             if (!link.isInTransaction()) {
                 logger.warn("Transactional was expected to be in a transaction, but it reported it wasn't.");
                 return false;
             }
             return true;
        }
