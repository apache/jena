...
public class TestRDFConnectionDatasetGraphOverRDFLinkNoTxn extends AbstractTestRDFConnection {
    @Override
    ...
    protected RDFConnection connection() {
        ...
        DatasetGraphOverRDFLink frontendDsg = DatasetGraphOverRDFLink.create(() -> RDFLink.connect(backendDsg));
