...
public class NodeTableTRDF_Direct extends NodeTableNative {
    // Version without smarts to do write buffering. 
    // Buffering is ~10% gain with an SSD.
    // Note that TFileTransport does not support writing.
    
    private TSimpleFileTransport file ;
    private final TProtocol      protocol ;
    private long                 position ;

    public NodeTableTRDF_Direct(Index nodeToId, String objectFile) {
        super(nodeToId) ;
        try {
