...
public class UpdateBuilderTest {
     ...
     * 
     * This snippet describes two RDF triples to be inserted into the default graph
     * of the Graph Store.
     * 
     ...
     * @prefix ns: <http://example.org/ns#> .
     * 
     * <http://example/book1> ns:price 42 . <http://example/book1> dc:title
     * "A new book" . <http://example/book1> dc:creator "A.N.Other" .
     * 
     */
    @Test
