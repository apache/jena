...
public class CollectionQuadHolderTest {
    ...
    public void anonymousGraphTest_List_Var() {
        ...
        List<Quad> lst = holder.getQuads().toList();
        assertEquals(2, lst.size());
        assertEquals(Quad.create(Quad.defaultGraphNodeGenerated, aLst.get(0)), lst.get(0));
        assertEquals(Quad.create(Quad.defaultGraphNodeGenerated, aLst.get(1)), lst.get(1));
    }
