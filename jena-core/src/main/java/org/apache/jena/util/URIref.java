...
public class URIref extends Object {
    ...
    static public String encode(String unicode) {
        ...
        return new String(rsltAscii,0,out,StandardCharsets.UTF_8);
    }
    ...
    static public String decode(String uri) {
        try {
            byte ascii[] = uri.getBytes(StandardCharsets.US_ASCII);
            ...
            return new String(utf8,0,out,StandardCharsets.UTF_8);
        }
