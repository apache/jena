...
import org.apache.jena.n3.turtlestar.parser.TurtleStarParser;
import org.apache.jena.util.FileUtils ;


public class ParserTurtleStar
{
    public ParserTurtleStar() {}
    ...
    public void parse(Graph graph, String baseURI, Reader reader)
    {
        ...
        try {
            TurtleStarParser parser = new TurtleStarParser(reader) ;
