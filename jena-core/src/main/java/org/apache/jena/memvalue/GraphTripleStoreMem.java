...
class GraphTripleStoreMem extends GraphTripleStoreBase implements TripleStore {
    ...
    NodeToTriplesMapMem getSubjects() {
        return (NodeToTriplesMapMem)subjects;
    }

    NodeToTriplesMapMem getPredicates() {
        return (NodeToTriplesMapMem)predicates;
    }

    NodeToTriplesMapMem getObjects() {
