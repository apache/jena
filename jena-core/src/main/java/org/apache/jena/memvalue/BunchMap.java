...
interface BunchMap {
    ...
    /**
     * Answer the TripleBunch associated with <code>key</code>, or <code>null</code>
     * if there isn't one.
     */
    public TripleBunch get(Object key);

    /**
     * Associate <code>key</code> and <code>value</code>. Any existing association of
     * <code>key</code> is lost. <code>get</code> on this key will now deliver this
     * value.
     */
    ...
    /**
     * Remove any association for <code>key</code>; <code>get</code> on this key will
     * now deliver <code>null</code>.
     */
