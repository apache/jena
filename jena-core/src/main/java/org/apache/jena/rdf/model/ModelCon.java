...
public interface ModelCon {
    ...
    * @param lex the lexical form of the literal
    * @param lang the language of the literal
    * @param dir the initial text direction of the literal
    */
    Model add(Resource s, Property p, String lex, String lang, String dircontains) ;
     ...
     * @param object    The value sought
     * @param lang      The lang code of the string.
     * @param direction The text direction of the string.
