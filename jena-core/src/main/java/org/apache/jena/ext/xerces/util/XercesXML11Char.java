    ...
    public static boolean isXML11ValidName(String name) {
        ...
        if (!isXML11NameStart(ch)) {
            if (length > 1 && isXML11NameHighSurrogate(ch)) {
                ...
                if (!XercesXMLChar.isLowSurrogate(ch2) || 
                    !isXML11NameStart(XercesXMLChar.supplemental(ch, ch2))) {
                    return false;
                }
                i = 2;
            }
        ...
        while (i < length) {
            ...
            if (!isXML11Name(ch)) {
                if (++i < length && isXML11NameHighSurrogate(ch)) {
                    ...
                    if (!XercesXMLChar.isLowSurrogate(ch2) || 
                        !isXML11Name(XercesXMLChar.supplemental(ch, ch2))) {
                        return false;
                    }
                }
                else {
    ...
    public static boolean isXML11ValidNCName(String ncName) {
        ...
        if (!isXML11NCNameStart(ch)) {
            if (length > 1 && isXML11NameHighSurrogate(ch)) {
                ...
                if (!XercesXMLChar.isLowSurrogate(ch2) || 
                    !isXML11NCNameStart(XercesXMLChar.supplemental(ch, ch2))) {
                    return false;
                }
                i = 2;
            }
        ...
        while (i < length) {
            ...
            if (!isXML11NCName(ch)) {
                if (++i < length && isXML11NameHighSurrogate(ch)) {
                    ...
                    if (!XercesXMLChar.isLowSurrogate(ch2) || 
                        !isXML11NCName(XercesXMLChar.supplemental(ch, ch2))) {
                        return false;
                    }
                }
                else {
