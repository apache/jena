...
/**
 * A copy of {@code org.apache.jena.graph.AbstractTestGraph}, kept package-scope here so that
 * {@link TestInfGraph} does not depend on the graph test package.
 */
abstract class AbstractTestGraph {
