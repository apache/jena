...
public class TS3_compose extends TestCase {
    ...
    public static TestSuite suite() {
        ...
        GraphModelFactory gmf = new GraphModelFactory() {
            ...
            @Override
            Graph getGraph() {
                return new Intersection(GraphMemFactory.createGraphMemForModel(), GraphMemFactory.createGraphMemForModel());
            }
        };
        ...
        gmf = new GraphModelFactory() {
            ...
            @Override
            Graph getGraph() {
                return new Difference(GraphMemFactory.createGraphMemForModel(), GraphMemFactory.createGraphMemForModel());
            }
        };
        ...
        gmf = new GraphModelFactory() {
            ...
            @Override
            Graph getGraph() {
                return new Union(GraphMemFactory.createGraphMemForModel(), GraphMemFactory.createGraphMemForModel());
            }
        };
