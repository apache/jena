...
public class TestPrefixMappingUtils {
    ...
    public void prefixesTTL() {
        ...
        pmapExpected.setNsPrefix("ex", "http://example/ex#");
        pmapExpected.setNsPrefix("indirect", "urn:foo:");
        // No : not a / or # split :: pmapExpected.setNsPrefix("ns",
        // "http://host/ns");
        // No : not a / or # split :: pmapExpected.setNsPrefix("ns1",
        // "http://host/ns1");
        // No : not a match: split is wrong :: pmapExpected.setNsPrefix("indirectx",
        // "urn:x:");
// print("Expected:", pmapExpected);
// print("Got:", pmap);
        Assert.assertTrue(sameMapping(pmapExpected, pmap));
