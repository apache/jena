...
public class TestAssemblerGroup extends AssemblerTestBase {
    ...
    public void testEmptyAssemblerGroup() {
        ...
        assertEquals(null, a.assemblerFor(ModelTestLib.resource("ja:Anything")));
    ...
    public void testMultipleAssemblerGroup() {
        ...
        JenaTestLib.assertInstanceOf(InfModel.class, a.openModel(resourceInModel("x rdf:type ja:InfModel")));
    ...
    public void testImpliedType() {
        ...
        a.implementWith(JA.InfModel, new NamedObjectAssembler(ModelTestLib.resource("x"), expected));
    ...
    public void testBuiltinGroup() {
        ...
        JenaTestLib.assertInstanceOf(InfModel.class, g.open(resourceInModel("x rdf:type ja:InfModel")));
    ...
    public void testAddingImplAddsSubclass() {
        ...
        Resource typeA = ModelTestLib.resource("typeA"), typeB = ModelTestLib.resource("typeB");
    ...
    public static class ImplementsSPOO {
        public static void whenRequiredByAssembler(AssemblerGroup g) {
            g.implementWith(ModelTestLib.resource("SPOO"), mockAssembler);
        }
    }
    ...
    public void testClassesLoadedBeforeAddingTypes() {
        ...
        g.implementWith(ModelTestLib.resource("ja:MemoryModel"), mockAssembler);
        g.open(root);
        assertEquals(ModelTestLib.resourceSet("SPOO ja:MemoryModel"), g.implementsTypes());
    }

    protected void assertMemoryModel(Object object) {
        if ( object instanceof Model ) {
            Graph g = ((Model)object).getGraph();
            JenaTestLib.assertInstanceOf(GraphBase.class, g);
        } else
