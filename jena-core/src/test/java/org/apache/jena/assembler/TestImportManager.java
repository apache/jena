...
public class TestImportManager extends AssemblerTestBase {
    ...
    static class FixedFileManager extends FileManagerImpl {
        ...
        @Override
        public Model loadModelInternal(String URL) {
            Model result = map.get(URL);
            if ( result == null )
                fail("no model for " + URL);
            return result;
        }
    ...
    public void testFollowOwlImports() {
        ...
        JenaTestLib.assertInstanceOf(MultiUnion.class, m2.getGraph());
    ...
    private void testBadImportObjectFails(String object) {
        ...
        try {
            ...
            assertEquals(ModelTestLib.rdfNode(m, object), e.getObject());
        }
    }
    ...
    public void testFollowOwlImportsDeeply() {
        ...
        JenaTestLib.assertInstanceOf(MultiUnion.class, result.getGraph());
    ...
    public void testCacheModels() {
        ...
        ModelTestLib.assertIsoModels(A, B);
    }
}
