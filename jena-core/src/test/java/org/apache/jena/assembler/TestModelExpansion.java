...
public class TestModelExpansion extends AssemblerTestBase {
    ...
    private String rdfList(String base, String types) {
        ...
        List<String> L = JenaTestLib.listOfStrings(types);
        String rest = "rdf:nil";
    ...
    public void testSubclassClosureC() {
        ...
        subClassClosure(m);
        ModelTestLib.assertIsoModels(model("A rdfs:subClassOf B; B rdfs:subClassOf C; A rdfs:subClassOf C; X rdfs:subClassOf C; Y rdfs:subClassOf X; Y rdfs:subClassOf C"),
                        m);
    }
    ...
    public void testSubclassClosureD() {
        ...
        subClassClosure(m);
        ModelTestLib.assertIsoModels(model("A rdfs:subClassOf B; B rdfs:subClassOf C; A rdfs:subClassOf C; X rdfs:subClassOf C; Y rdfs:subClassOf X; Y rdfs:subClassOf C; U rdfs:subClassOf A; U rdfs:subClassOf B; U rdfs:subClassOf C; U rdfs:subClassOf X; U rdfs:subClassOf Y"),
                        m);
    }
