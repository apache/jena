...
public class TestReasonerFactoryAssembler extends AssemblerTestBase {
    ...
    public void testBadReasonerURLFails() {
        ...
        try {
            ...
            assertEquals(ModelTestLib.resource("bad:URL"), e.getURL());
        }
    }
    ...
    public void testReasonerClassInstantiatesIfNoInstance() {
        ...
        Resource root = resourceInModel(description + MockName);
        JenaTestLib.assertInstanceOf(MockBase.class, ASSEMBLER.open(root));
    ...
    public void testSchema() {
        ...
        Assembler sub = new NamedObjectAssembler(ModelTestLib.resource("S"), schema);
    ...
    public void testSingleRules() {
        ...
        Assembler mock = new AssemblerBase() {
            ...
            public Object open(Assembler a, Resource root, Mode irrelevant) {
                assertEquals(root, ModelTestLib.resource("S"));
                return rules;
            }
        };
    ...
    public void testMultipleRules() {
        ...
        Assembler mock = new AssemblerBase() {
            @Override
            public Object open(Assembler a, Resource root, Mode irrelevant) {
                if ( root.equals(ModelTestLib.resource("S")) )
                    return rulesA;
                if ( root.equals(ModelTestLib.resource("T")) )
                    return rulesB;
    ...
    protected void testReasonerURL(Class<? > wanted, String string) {
        ...
        JenaTestLib.assertInstanceOf(wanted, rf);
    }
}
