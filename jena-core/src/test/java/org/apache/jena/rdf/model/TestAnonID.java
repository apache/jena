...
public class TestAnonID extends JenaTestBase {
    ...
    public void doTestAnonID() {
        ...
        JenaTestLib.assertDiffer(id1, id2);
        JenaTestLib.assertDiffer(id1, id3);
        JenaTestLib.assertDiffer(id1, id4);
        JenaTestLib.assertDiffer(id2, id3);
        JenaTestLib.assertDiffer(id2, id4);
    }
