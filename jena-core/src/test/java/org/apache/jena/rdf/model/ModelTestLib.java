...
/**
 * Provides useful functionality for testing models, e.g. building small models from
 * strings, testing equality, etc.
 */

public class ModelTestLib  {

    private static Model aModel = ModelTestLib.createModel();
    public static final Model empty = ModelFactory.createModelForGraph(Graph.emptyGraph);
    ...
    public static void assertIsoModels(final Model wanted, final Model got) {
        ModelTestLib.assertIsoModels("models must be isomorphic", wanted, got);
    }
    ...
    public static Literal literal(final Model m, final String s) {
        return ModelTestLib.rdfNode(m, s).as(Literal.class);
    }
    ...
    public static Model modelAdd(final Model m, final String facts) {
        ...
        while (semis.hasMoreTokens()) {
            m.add(ModelTestLib.statement(m, semis.nextToken()));
        }
        return m;
    }
    ...
    public static Model modelWithStatements(final String facts) {
        return ModelTestLib.modelAdd(ModelTestLib.createModel(), facts);
    }
    ...
    public static Property property(final Model m, final String s) {
        return ModelTestLib.rdfNode(m, s).as(Property.class);
    }

    public static Property property(final String s) {
        return ModelTestLib.property(ModelTestLib.aModel, s);
    }
    ...
    public static <T extends RDFNode> T rdfNode(final Model m, final String s, final Class<T> c) {
        return ModelTestLib.rdfNode(m, s).as(c);
    }
    ...
    public static Resource resource(final Model m, final String s) {
        return (Resource)ModelTestLib.rdfNode(m, s);
    }

    public static Resource resource(final String s) {
        return ModelTestLib.resource(ModelTestLib.aModel, s);
    }
    ...
    public static Resource[] resources(final Model m, final String items) {
        ...
        while (st.hasMoreTokens()) {
            rl.add(ModelTestLib.resource(m, st.nextToken()));
        }
        return rl.toArray(new Resource[rl.size()]);
    }

    /**
     * Answer the set of resources given by the space-separated <code>items</code>
     * string. Each resource specification is interpreted as per
     * <code>resource</code>.
     */
    public static Set<Resource> resourceSet(final String items) {
        ...
        final StringTokenizer st = new StringTokenizer(items);
        while (st.hasMoreTokens()) {
            result.add(ModelTestLib.resource(st.nextToken()));
        }
        return result;
    }
    ...
    public static Statement statement(final Model m, final String fact) {
        ...
        final Resource sub = ModelTestLib.resource(m, st.nextToken());
        final Property pred = ModelTestLib.property(m, st.nextToken());
        final RDFNode obj = ModelTestLib.rdfNode(m, st.nextToken());
        return m.createStatement(sub, pred, obj);
    }

    public static Statement statement(final String fact) {
        return ModelTestLib.statement(ModelTestLib.aModel, fact);
    }
    ...
    public static Statement[] statements(final Model m, final String facts) {
        ...
        while (st.hasMoreTokens()) {
            sl.add(ModelTestLib.statement(m, st.nextToken()));
        }
