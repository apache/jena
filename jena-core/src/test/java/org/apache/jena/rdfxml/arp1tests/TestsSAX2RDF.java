...
public class TestsSAX2RDF extends TestCase {

	protected static Logger logger = LoggerFactory.getLogger( TestsSAX2RDF.class );
	...
	static public TestSuite suite() {
		TestSuite s = new TestSuite("SAX2RDFTest");
//		s.addTestSuite(PushMePullYouTest.class);
		s.addTestSuite(TestsSAX2RDFMore.class);
...
//			String nm = all[i];
	...
	static private void addTests(TestSuite s, String dir, String base, String file){
		TestCase tc = new TestsSAX2RDF(dir,base,file);
		tc.setName("SAX "+tc.getName());
		s.addTest(tc);

		tc = new TestsDOM2RDF(dir,base,file);
	...
	TestsSAX2RDF(String dir, String base0, String file) {
		super(file);
		//this.dir = dir;
