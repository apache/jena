...
/**
 Tests for spellings of OWL2 terms and their relationship with OWL[1] terms.
 */
public class TestOWL2Vocabulary {
    ...
    private void assertProperty( Property p, String local )
        { VocabTestLib.assertProperty( OWL2.getURI() + local, p ); }

    private void assertResource( Resource r, String local )
        { VocabTestLib.assertResource( OWL2.getURI() + local, r ); }
}
