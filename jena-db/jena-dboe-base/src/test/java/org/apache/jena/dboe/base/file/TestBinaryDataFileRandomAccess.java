...
public class TestBinaryDataFileRandomAccess {
    ...
    @Test public void bad_truncate() {
        ...
        BinaryDataFileRandomAccess subject = new BinaryDataFileRandomAccess(file.toString());
        subject.open();
        try {
    ...
    @Test public void bad_seek_read() {
        ...
        try {
            ...
            assertThrows(RuntimeIOException.class, ()->subject.read(2048, block2));

            subject.truncate(512);
            // Now not OK.
            assertThrows(RuntimeIOException.class, ()->subject.read(1024, block2));
        } finally { subject.close(); }
    }
