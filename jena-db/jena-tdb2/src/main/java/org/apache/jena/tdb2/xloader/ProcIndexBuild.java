...
{
    public static void exec(DatasetGraph dsg, String indexName, String dataFile) {
        ...
        BPlusTree bpt2 = BPlusTreeRewriter.packIntoBPlusTree(iter, bptParams, recordFactory, blkState, blkMgrNodes, blkMgrRecords);
        bpt2.close();
    }
}
