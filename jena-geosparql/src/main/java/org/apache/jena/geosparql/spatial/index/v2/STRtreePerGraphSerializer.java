    ...
    extends Serializer<STRtreePerGraph>
{
    ...
    public void write(Kryo kryo, Output output, STRtreePerGraph index) {
        kryo.writeObject(output, index.getDefaultTree());
        kryo.writeClassAndObject(output, index.getNamedTreeMap());
    }
    ...
    public STRtreePerGraph read(Kryo kryo, Input input, Class<STRtreePerGraph> type) {
        ...
        STRtreePerGraph result = new STRtreePerGraph(defaultGraphTree, graphToTree);
        return result;
    }
}
