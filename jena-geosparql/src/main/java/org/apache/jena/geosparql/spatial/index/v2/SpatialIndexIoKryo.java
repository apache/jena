...
import org.apache.jena.geosparql.spatial.index.v2.serde.GeometrySerdeAdapterJtsWkb;
import org.apache.jena.geosparql.spatial.index.v2.serde.JtsKryoRegistrator;
...
public class SpatialIndexIoKryo {
    ...
    public static SpatialIndex buildSpatialIndex(Dataset dataset,
        ...
        if (spatialIndex.isEmpty()) {
            spatialIndex = SpatialIndexUtils.buildSpatialIndex(dataset.asDatasetGraph(), srsURI, spatialIndexPerGraph);
     ...
     */
    public static SpatialIndex buildSpatialIndex(Dataset dataset, String srsURI, Path spatialIndexFile) throws SpatialIndexException {
    ...
    public static SpatialIndex buildSpatialIndex(Dataset dataset, Path spatialIndexFile, boolean spatialIndexPerGraph) throws SpatialIndexException {
    ...
    public static final SpatialIndexPerGraph load(Path spatialIndexFile) throws SpatialIndexException {
        ...
        if (spatialIndexFile != null && Files.exists(spatialIndexFile)) {
            ...
            try (Input input = new Input(Files.newInputStream(spatialIndexFile))) {
                ...
                index = new STRtreePerGraph(defaultGraphTree, graphToTree);
