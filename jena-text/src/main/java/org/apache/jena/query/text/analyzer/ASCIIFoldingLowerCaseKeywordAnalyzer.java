...
public class ASCIIFoldingLowerCaseKeywordAnalyzer extends Analyzer {
        private Version version;
        
        public ASCIIFoldingLowerCaseKeywordAnalyzer(Version ver) {
                this.version = ver;
        }
        ...
        protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
                ...
                LowerCaseFilter filter1 = new LowerCaseFilter(version, source);
                ASCIIFoldingFilter filter2 = new ASCIIFoldingFilter(filter1);
