...
public class StoreSimpleH2 extends StoreBase1
{

    public StoreSimpleH2(SDBConnection connection, StoreDesc desc)
    {
        this(connection, desc, new TableDescSPO(), new CodecSimple()) ;
    }

    private StoreSimpleH2(SDBConnection connection, StoreDesc desc,
