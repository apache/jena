...
import org.apache.jena.sparql.exec.tracker.DatasetGraphWithExecTracker;
...
public class TestFMod_ExecTracker {
    ...
    public void setUp() throws IOException {
        ...
        dsg = DatasetGraphWithExecTracker.wrap(dsg);
        ...
        FusekiServer server = FusekiMain.builder(argv)
            ...
            .addEndpoint("test", "tracker", FMod_ExecTracker.getOperation())
            .build();
        server.start();
