...
/**
 * TestDatasetAccessorHTTP does most of the GSP testing. This class adds the testing
 * of Jena Fuseki extras - whole dataset HTTP.
 */
public class TestDatasetOps extends AbstractFusekiTest {
    static DatasetGraph data = SSE.parseDatasetGraph(StrUtils.strjoinNL("(prefix ((: <http://example/>))", "  (dataset",
        "    (graph (_:x :p 1) (_:x :p 2))", "    (graph :g (_:x :p 3))", "))"));
