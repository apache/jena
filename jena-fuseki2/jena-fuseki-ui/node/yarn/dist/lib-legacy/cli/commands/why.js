...
let getPackageSize = (() => {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (_ref2) {
    var _ref4 = (0, (_slicedToArray2 || _load_slicedToArray()).default)(_ref2, 2);
...
let run = exports.run = (() => {
  var _ref8 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, reporter, flags, args) {
    ...
    const transitiveKeys = new (_set || _load_set()).default(transitiveDependencies.map(function (_ref13) {
...
const collect = function collect(hoistManifests, allDependencies, dependency) {
