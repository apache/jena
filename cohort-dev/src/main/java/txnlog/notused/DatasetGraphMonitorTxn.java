...
public class DatasetGraphMonitorTxn extends DatasetGraphWrapper
{
     ...
     * @see QuadAction
     */
    public DatasetGraphMonitorTxn(DatasetGraph dsg, DatasetChanges monitor) 
    {
        this(dsg, monitor, true) ;
    }
     ...
     * @see QuadAction
     */
    public DatasetGraphMonitorTxn(DatasetGraph dsg, DatasetChanges monitor, boolean recordOnlyIfRealChange) 
    {
        super(dsg) ;
