...
public class DatasetGraphWrapperTxn implements DatasetGraph, Transactional
{
    ...
    public DatasetGraphWrapperTxn(DatasetGraph dsg) {
        if ( dsg instanceof Transactional ) {
            transactional = (Transactional)dsg ;
        } else
            throw new TransactionException("Not a transactional dataset") ;
