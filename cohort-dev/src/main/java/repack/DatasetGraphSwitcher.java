...
// Exactly DatasetGraphWrapper except non-final dsg
// protected DatasetGraph get() { return dsg ; }
public class DatasetGraphSwitcher implements DatasetGraph, Sync  {
        ...
        public DatasetGraphSwitcher(DatasetGraph dsg) {
            this.dsg = dsg ;
        }
