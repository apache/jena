...
public class QueryTaskBuilderRegistry {
    ...
    private final Map<String, Supplier<QueryTaskBuilder>> registry = new ConcurrentHashMap<>();
    ...
    public Supplier<QueryTaskBuilder> get(String name) {
        return Optional.ofNullable(registry.get(name))
            .orElseThrow(() -> new NoSuchElementException("No task builder with name " + name));
    }

    public void put(String name, Supplier<QueryTaskBuilder> builderFactory) {
