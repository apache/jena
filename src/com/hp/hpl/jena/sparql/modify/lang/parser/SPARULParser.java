/* Generated By:JavaCC: Do not edit this line. SPARULParser.java */
/*
...
public class SPARULParser extends SPARULParserBase implements SPARULParserConstants {

  final public void SPARUL() throws ParseException {
    Prologue();
    label_1:
    while (true) {
...
// by expanding out FunctionCall()
  ...
  public SPARULParserTokenManager token_source;
  ...
  public SPARULParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new SPARULParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
