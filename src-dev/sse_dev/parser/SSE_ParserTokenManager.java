...
private final int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 63:
         return jjStartNfaWithStates_0(0, 36, 21);
      case 64:
         return jjStartNfaWithStates_0(0, 35, 90);
      case 91:
      ...
      case 123:
         return jjStartNfaWithStates_0(0, 30, 66);
      case 125:
         return jjStartNfaWithStates_0(0, 31, 66);
      default :
...
private final int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      case 94:
         if ((active0 & 0x400000000L) != 0L)
            return jjStartNfaWithStates_0(1, 34, 66);
         break;
      default :
         break;
   }
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 30:
                  ...
                  break;
               case 31:
                  if ((0x14404410000000L & l) != 0L && kind > 23)
                     kind = 23;
                  break;
               case 33:
...
static final int[] jjnextStates = {
   68, 69, 70, 74, 75, 81, 82, 68, 69, 72, 74, 1, 2, 4, 38, 39, 
   41, 33, 34, 36, 9, 10, 13, 14, 17, 18, 43, 44, 45, 47, 48, 50, 
   54, 55, 56, 58, 59, 61, 9, 10, 11, 6, 7, 78, 79, 83, 84, 88, 
   89, 
};
...
null, "\50", "\51", "\173", "\175", "\133", "\135", "\136\136", "\100", "\77", null, 
