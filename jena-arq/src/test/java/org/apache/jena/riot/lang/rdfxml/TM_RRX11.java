...
public class TM_RRX11 {
    ...
    @TestFactory
    @Order(1)
    @DisplayName("RIOT RRX 11-2 SAX")
    public Stream<DynamicNode> testFactory1() {
        return withAltParserFactory(Lang.RDFXML, ReaderRDFXML_SAX.factory, MANIFEST_MISC_RDFXML);
    }

    @TestFactory
    @Order(2)
    @DisplayName("RIOT RRX 11-2 StAXev")
    public Stream<DynamicNode> testFactory2() {
        return withAltParserFactory(Lang.RDFXML, ReaderRDFXML_StAX_EV.factory, MANIFEST_MISC_RDFXML);
    }

    @TestFactory
    @Order(3)
    @DisplayName("RIOT RRX 11-2 StAXsr")
    public Stream<DynamicNode> testFactory3() {
        return withAltParserFactory(Lang.RDFXML, ReaderRDFXML_StAX_SR.factory, MANIFEST_MISC_RDFXML);
    }
}
