...
{
    private static boolean systemWarnFlag;

    @BeforeAll
    public static void beforeAll() {
        systemWarnFlag = E_Function.WarnOnUnknownFunction;
        E_Function.WarnOnUnknownFunction = false;
    }

    @AfterAll
    public static void afterAll() {
        E_Function.WarnOnUnknownFunction = systemWarnFlag;
    }
    ...
    @Test
    public void gregorian_eq_03()               { assertThrows(ExprEvalException.class, ()-> eval("'1999'^^xsd:gYear = '1999Z'^^xsd:gYear") ); }
    ...
    @Test
    public void gregorian_eq_06()               { assertThrows(ExprEvalException.class, ()-> eval("'--01'^^xsd:gMonth != '--01-25'^^xsd:gMonthDay", true) ); }
    ...
    @Test
    public void gregorian_cmp_04()              { assertThrows(ExprEvalException.class, ()-> eval("'1999'^^xsd:gYear < '1999+05:00'^^xsd:gYear") ); }
    ...
    @Test
    public void term_constructor_iri_02()           { assertThrows(ExprEvalException.class, ()-> eval("IRI(123)") ); }
    ...
    @Test
    public void term_constructor_strdt_03()         { assertThrows(ExprEvalException.class, ()-> eval("STRDT('123','abc') = '123'") ); }
    @Test
    public void term_constructor_strdt_04()         { assertThrows(ExprEvalException.class, ()-> eval("STRDT('123'^^xsd:integer,<http://example/DT>) = '123'^^<http://example/DT>") ); }

    @Test public void term_constructor_strlang_01() { eval("STRLANG('abc', 'en') = 'abc'@en", true); }
    @Test
    public void term_constructor_strlang_02()       { assertThrows(ExprEvalException.class, ()-> eval("STRLANG(<http://example/>, 'en') = 'abc'@en") ); }

    @Test
    public void term_constructor_strlang_03()       { assertThrows(ExprEvalException.class, ()-> eval("STRLANG('abc'@en, 'en') = 'abc'@en") ); }
    ...
    @Test
    public void xsd_cast_10()                       { assertThrows(ExprEvalException.class, ()-> eval("xsd:integer(' 1')") ); }
    @Test
    public void xsd_cast_11()                       { assertThrows(ExprEvalException.class, ()-> eval("xsd:boolean(' 1')") ); }
    @Test
    public void xsd_cast_12()                       { assertThrows(ExprEvalException.class, ()-> eval("xsd:double(' 1.0e0')") ); }
    @Test
    public void xsd_cast_13()                       { assertThrows(ExprEvalException.class, ()-> eval("xsd:double(' 1.0e0')") ); }

    // Dynamic Function Calls
    @Test
    public void dynamic_call_01()                   { assertThrows(QueryParseException.class, ()-> eval("CALL()", false) ); }

    @Test public void dynamic_call_02()             { eval("CALL(xsd:double, '1') = 1"); }
    @Test public void dynamic_call_03()             { eval("CALL(fn:concat, 'A', 2+3 ) = 'A5'"); }

    @Test
    public void dynamic_call_10()                   { assertThrows(ExprEvalException.class, ()-> eval("CALL(xsd:double)") ); }
    @Test
    public void dynamic_call_11()                   { assertThrows(ExprEvalException.class, ()-> eval("CALL(xsd:noSuchFunc)") ); }
