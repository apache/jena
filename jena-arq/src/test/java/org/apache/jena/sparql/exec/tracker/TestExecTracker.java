...
public class TestExecTracker {
    ...
    public void test() {
        ...
        TaskTrackerRegistry tracker = TaskTrackerRegistry.getOrSet(dsg.getContext());
        HistoryTrackerRegistry history = HistoryTrackerRegistry.ensureTracker(dsg.getContext());
