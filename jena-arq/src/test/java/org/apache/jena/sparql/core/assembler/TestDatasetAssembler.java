...
public class TestDatasetAssembler extends Assert {
    ...
    Dataset assemble(final Resource example) {
        Model model = example.getModel() ;
        model.setNsPrefix("ja", JA.getURI()) ;
        final DatasetAssembler testAssembler = createAssembler();
    ...
    public void emptyDataset() {
        ...
        empty.addProperty(type, assemblerType()) ;
    ...
    public void directDataQuadsString() throws IOException {
        ...
        simpleExample2.addProperty(type, assemblerType()) ;
