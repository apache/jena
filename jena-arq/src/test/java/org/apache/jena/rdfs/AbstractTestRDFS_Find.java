    ...
    extends AbstractDatasetGraphCompare
{
    ...
    public GraphFindTestBuilder prepareRdfsFindTests(String schemaStr, String dataStr) {
        Graph schemaGraph = RDFParser.fromString(schemaStr, Lang.TTL).toGraph();
        SetupRDFS setup = RDFSFactory.setupRDFS(schemaGraph);
        return prepareRdfsFindTests(setup, dataStr);
    }

    public GraphFindTestBuilder prepareRdfsFindTests(ConfigRDFS<Node> configRDFS, String dataStr) {
