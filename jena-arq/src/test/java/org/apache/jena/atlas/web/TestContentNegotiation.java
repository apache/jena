...
public class TestContentNegotiation
{
    ...
    @Test public void qualNeg2() {
        testMatch("text/turtle,application/rdf+xml;q=0.5",
    ...
    @Test public void qualNeg4() {
        testMatch("application/rdf+xml;q=0.5,text/turtle",
                  "text/turtle,application/rdf+xml",
                  "text/turtle");
    }
    ...
    @Test public void connegResultSet_01() {
        testMatch("application/sparql-results+json , application/sparql-results+xml;q=0.9 , application/rdf+xml , application/turtle;q=0.9 , */*;q=0.1",
                  offerResultSet,
                  "application/sparql-results+json");
    }

    @Test public void connegResultSet_02() {
        testMatch("application/sparql-results+xml;q=0.9, */*;q=0.1",
                  offerResultSet,
...
//    conneg("application/sparql-results+json;q=0.9, */*;q=0.1", DEF.rsOffer);
    ...
    @Test public void connegResultSet_03() {
        testMatch("application/sparql-results+json;q=0.9, */*;q=0.1",
                  offerResultSet,
                 "application/sparql-results+json");
    }
    ...
    @Test public void conneg_01() {
        ...
        testMatch("application/sparql-results+json , application/sparql-results+xml;q=0.9 , text/turtle, application/rdf+xml;q=0.9 , */*;q=0.1",
                  offerRDF,
                  "text/turtle");
    }

    @Test public void connegRDF_01() {
        testMatch("application/rdf+xml , text/turtle;q=0.9 , */*;q=0.1",
                  offerRDF,
                  "application/rdf+xml");
    }

    @Test public void connegRDF_02() {
        testMatch("application/turtle;q=0.9 , application/rdf+xml , */*;q=0.1",
                  offerRDF,
                  "application/rdf+xml");
    }
    ...
    private void testMatch(String header, String offer, String result) {
        ...
        if ( result == null ) {
            assertNull(matchItem, () -> "Match not null: from " + q(header) + " :: " + q(offer));
            return;
        }
        assertNotNull(matchItem, () -> "Match is null: expected " + q(result));
        assertEquals(result, matchItem.toHeaderString(), () -> "Match different");
    }
