...
public class VocabLangRDF
{
    ...
    public static final Resource TestNTriplesNegativeC14N   = m_model.createResource( NS+"TestNTriplesNegativeC14N" );
    public static final Resource TestNQuadsPositiveC14N     = m_model.createResource( NS+"TestNQuadsPositiveC14N" );
    public static final Resource TestNQuadsNegativeC14N     = m_model.createResource( NS+"TestNQuadsNegativeC14N" );
