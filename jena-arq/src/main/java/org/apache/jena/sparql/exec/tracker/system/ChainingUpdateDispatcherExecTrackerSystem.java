...
public class ChainingUpdateDispatcherExecTrackerSystem
    implements ChainingUpdateDispatcher
{
    @Override
    public UpdateExec create(UpdateRequest updateRequest, DatasetGraph dsg, Context context, UpdateDispatcher chain) {
        UpdateExec delegate = chain.create(updateRequest, dsg, context);
