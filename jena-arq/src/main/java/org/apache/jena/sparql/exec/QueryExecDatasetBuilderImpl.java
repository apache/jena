...
public class QueryExecDatasetBuilderImpl implements QueryExecMod, QueryExecDatasetBuilder {
    ...
    @Override
    public QueryExecDatasetBuilderImpl initialBinding(Binding binding) {
    ...
    public QueryExec build() {
        ...
        if ( qeFactory == null ) {
            Log.warn(QueryExecDatasetBuilderImpl.class, "Failed to find a QueryEngineFactory");
            return null;
        }
        ...
        for (QueryExecTransform queryExecTransform : queryExecTransforms) {
            qExec = queryExecTransform.transform(qExec);
        }
