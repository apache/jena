...
public interface TripleTable extends TupleTable<Triple> {
     ...
     * @param second
     * @param third
     * @return a Triple in internal order
     */
    default Triple tuple(final Node first, final Node second, final Node third) {
     ...
     * @param second
     * @param third
     * @return a Triple in spo order
     */
    default Triple detuple(final Node first, final Node second, final Node third) {
        return detuple(create(first, second, third));
    }
}
