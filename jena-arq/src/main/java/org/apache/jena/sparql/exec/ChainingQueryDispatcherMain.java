...
{
    private static final ChainingQueryDispatcherMain INSTANCE = new ChainingQueryDispatcherMain();
    public static ChainingQueryDispatcher get() {
        return INSTANCE;
    }

    private ChainingQueryDispatcherMain() {}

    @Override
    public QueryExec create(Query queryActual, DatasetGraph dataset, Context cxt, QueryDispatcher chain) {
