...
public class ARQParser extends ARQParserBase implements ARQParserConstants {
  ...
  final public Element LateralGraphPattern() throws ParseException {
                                  Element el ;
    jj_consume_token(LATERAL);
    el = GroupGraphPattern();
      {if (true) return new ElementLateral(el) ;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Node QuotedTriple() throws ParseException {
  ...
  final public Node QuotedTripleData() throws ParseException {
...
>>>>>>> b5d4838066 (extends SPARQL parser to recognize ORDER BY for FOLD)
  ...
  final public Node ExprQuotedTriple() throws ParseException {
...
>>>>>>> b5d4838066 (extends SPARQL parser to recognize ORDER BY for FOLD)
    ...
    case ADJUST:
      ...
      jj_consume_token(RPAREN);
      {if (true) return new E_AdjustToTimezone(expr1, expr2) ;}
      break;
    case NOW:
