...
public abstract class AbstractIterHashJoin extends QueryIter2 {
    ...
    protected AbstractIterHashJoin(JoinKey joinKey, QueryIterator probeIter, QueryIterator streamIter, ExecutionContext execCxt) {
        ...
        if ( false && joinKey == null ) {
            // This block creates a join key from at most one variable common in
            // either side's first binding.
            // This block is superseded by improved handling of join keys in MultiHashProbeTable.
        ...
        this.hashTable = new MultiHashProbeTable(joinKey) ;
