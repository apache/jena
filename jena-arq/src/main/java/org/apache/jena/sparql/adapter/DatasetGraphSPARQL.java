 ...
 * For such custom dataset graphs, specialized providers for SPARQL query and update execution
 * can be registered with the {@link SparqlAdapterRegistry}.
 * This can deliver improved SPARQL update and query performance over direct use of the
 * DatasetGraph API.
 *
 * <p>
 ...
 *
 * <p>
 * All method invocations build a single, possibly compound, update request.
 */
