...
{
    private static final ChainingUpdateDispatcherMain INSTANCE = new ChainingUpdateDispatcherMain();
    public static ChainingUpdateDispatcher get() {
        return INSTANCE;
    }

    private ChainingUpdateDispatcherMain() {}

    @Override
    public UpdateExec create(UpdateRequest updateRequest, DatasetGraph dataset, Context cxt, UpdateDispatcher chain) {
