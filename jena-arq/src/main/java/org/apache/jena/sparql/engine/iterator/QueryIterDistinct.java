...
/**
 * A QueryIterator that suppresses items already seen. This will stream results until
...
public class QueryIterDistinct extends QueryIter1 {
    ...
    /**
     * Return the next binding from the input filtered by seen. This does not update
