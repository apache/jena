...
public class Closure {
    /**
     * Calculate the bNode closure from a statement . The Statement itself does not
    ...
    /**
     * Calculate the bNode closure from a resource. The Statement itself does not
     * automatically get included.
     *
     * @param resource Starting point for the closure.
     * @param testThisNode Indicate whether to apply the closure test to the Resource
     *     argument.
     * @return A model containing statements
     */
    ...
    public static Model closure(Resource resource, ClosureTest test, boolean testThisNode) {
        return closure(resource, test, testThisNode, GraphFactory.makeDefaultModel());
    }
