...
import org.apache.jena.sparql.lang.sparql_10.javacc.SPARQLParser10;
...
public class ParserSPARQL10 extends SPARQLParser
{
    ...
    private static void perform(Query query, String string, Action action) {
        ...
        try {
            ...
            action.exec(parser);
        } catch (org.apache.jena.sparql.lang.sparql_10.javacc.ParseException ex) {
            throw new QueryParseException(ex.getMessage(), ex.currentToken.beginLine, ex.currentToken.beginColumn);
        } catch (org.apache.jena.sparql.lang.sparql_10.javacc.TokenMgrError tErr) {
