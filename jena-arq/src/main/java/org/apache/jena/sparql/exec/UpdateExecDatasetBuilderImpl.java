...
public class UpdateExecDatasetBuilderImpl implements UpdateExecDatasetBuilder {
    ...
    private List<UpdateExecTransform> updateExecTransforms = new ArrayList<>();

    private UpdateExecDatasetBuilderImpl() {}

    /** Append the updates in an {@link UpdateRequest} to the {@link UpdateRequest} being built. */
    @Override
    public UpdateExecDatasetBuilderImpl update(UpdateRequest updateRequest) {
    ...
    @Override
    public UpdateExecDatasetBuilderImpl update(Update update) {
    ...
    @Override
    public UpdateExecDatasetBuilderImpl update(String updateRequestString) {
    ...
    @Override
    public UpdateExecDatasetBuilderImpl parseCheck(boolean parseCheck) {
        return this;
    }
     ...
     * */
    @Override
    public UpdateExecDatasetBuilderImpl context(Context context) {
        if ( context == null )
            return this;
    ...
    @Override
    public UpdateExecDatasetBuilderImpl set(Symbol symbol, Object value) {
        this.contextAcc.set(symbol, value);
        return this;
    }

    @Override
    public UpdateExecDatasetBuilderImpl set(Symbol symbol, boolean value) {
        this.contextAcc.set(symbol, value);
        return this;
    }
    ...
    @Override
    public UpdateExecDatasetBuilderImpl substitution(Binding binding) {
    ...
    @Override
    public UpdateExecDatasetBuilderImpl substitution(Var var, Node value) {
        ensureSubstitutionMap();
    ...
    @Override
    public UpdateExecDatasetBuilderImpl timeout(long timeout, TimeUnit timeoutUnit) {
    ...
    public UpdateExecDatasetBuilderImpl initialBinding(Binding initialBinding) {
        this.initialBinding = initialBinding;
        return this;
    }

    @Override
    public UpdateExecDatasetBuilderImpl transformExec(UpdateExecTransform updateExecTransform) {
    ...
    public UpdateExec build() {
        ...
        for (UpdateExecTransform updateExecTransform : updateExecTransforms) {
            uExec = updateExecTransform.transform(uExec);
        }
