...
public interface TupleTable<TupleType> extends Transactional {
    ...
    /**
     * @param t a tuple in canonical order
     * @return a tuple in internal order
     */
    default TupleType tuple(final TupleType t) { return t; }

    /**
     * @param t a tuple in internal order
     * @return a tuple in canonical order
     */
    default TupleType detuple(final TupleType t) { return t; }
