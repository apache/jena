...
import static org.apache.jena.http.HttpLib.modifyByService;
...
public class UpdateExecHTTPImpl implements UpdateExecHTTP {
    ...
    /*package*/ UpdateExecHTTPImpl(String serviceURL, UpdateRequest update, String updateString,
