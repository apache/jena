...
public class Iso {
    ...
    /**
     * Are lists of triples isomorphic? The mapping policy {@link NodeIsomorphismMap}
     * is mutated.
     */
    ...
    /**
     * Are lists of quads isomorphic? The mapping policy {@link NodeIsomorphismMap}
     * is mutated.
     */
    ...
    /**
     * Are lists of nodes isomorphic? The mapping policy {@link NodeIsomorphismMap}
     * is mutated.
     */
    ...
    /**
     * Are two triple paths isomorphic? The mapping policy {@link NodeIsomorphismMap}
     * is mutated.
     */
    ...
    /**
     * Are two triples isomorphic? The mapping policy {@link NodeIsomorphismMap} is
     * mutated.
     */
    ...
    /**
     * Are two quads isomorphic? The mapping policy {@link NodeIsomorphismMap} is
     * mutated.
     */
    ...
    /**
     * Are two nodes isomorphic? The mapping policy {@link NodeIsomorphismMap} is
     * mutated.
     */
    public static boolean nodeIso(Node n1, Node n2, NodeIsomorphismMap isoMap) {
        if ( isoMap != null ) {
            ...
            if ( n1.isTripleTerm() && n2.isTripleTerm() )
                return tripleIso(n1.getTriple(), n2.getTriple(), isoMap);
            if ( n1.isNodeGraph() && n2.isNodeGraph() ) {
                List<Triple> list1 = n1.getGraph().find().toList();
                List<Triple> list2 = n2.getGraph().find().toList();
                return isomorphicTriples(list1, list2, isoMap);
            }
        }
        return n1.equals(n2);
    }
