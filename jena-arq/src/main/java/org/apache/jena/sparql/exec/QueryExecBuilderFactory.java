...
/**
 * Factory for {@link QueryExecBuilder} instances that are created only
 * when this provider accepts the given {@link DatasetGraph} and {@link Context}.
 *
 * Providers are registered with {@link QueryExecBuilderRegistry}.
 *
 * @see QueryExecBuilderRegistry
 */
public interface QueryExecBuilderFactory {
    /**
