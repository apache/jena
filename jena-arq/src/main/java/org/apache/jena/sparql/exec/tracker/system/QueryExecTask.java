...
import org.apache.jena.sparql.exec.tracker.core.ThrowableTrackerFirst;
    ...
    implements BasicTaskExec
{
     ...
     */
    protected QueryExecTask(QueryExec delegate, Instant creationTime, TaskListener<? super QueryExecTask> listener) {
    ...
    public static QueryExecTask create(QueryExec delegate, Instant creationTime, TaskListener<? super QueryExecTask> listener) {
