 ...
 */
public class UpdateExecDatasetBuilderMain
    extends UpdateExecBuilderBase<UpdateExecDatasetBuilderMain>
    implements UpdateExecDatasetBuilder
{
    public static UpdateExecDatasetBuilderMain create() { return new UpdateExecDatasetBuilderMain(); }

    private UpdateExecDatasetBuilderMain() {}

    @Override
    public UpdateExecDatasetBuilderMain dataset(DatasetGraph dsg) {
        this.dataset = dsg;
        return this;
    }
