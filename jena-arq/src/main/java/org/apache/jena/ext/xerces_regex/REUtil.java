...
public final class REUtil {
    ...
    static final int parseOptions(String opts) throws RegexParseException {
        if (opts == null)  return 0;
        int options = 0;
        for (int i = 0;  i < opts.length();  i ++) {
            int v = getOptionValue(opts.charAt(i));
            if (v == 0)
                throw new RegexParseException("Unknown Option: "+opts.substring(i), -1);
            options |= v;
        }
        return options;
    }
     ...
     */
    public static boolean matches(String regex, String target) throws RegexParseException {
     ...
     * @see RegularExpression#matches(java.lang.String)
     */
    public static boolean matches(String regex, String options, String target) throws RegexParseException {
