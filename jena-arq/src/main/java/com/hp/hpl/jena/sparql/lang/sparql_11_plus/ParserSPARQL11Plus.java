...
public class ParserSPARQL11Plus extends SPARQLParser
{
    private interface Action { void exec(SPARQLParser11Plus parser) throws Exception ; }
    
    @Override
    protected Query parse$(final Query query, String queryString)
    {
        query.setSyntax(SPARQL_11_PLUS.syntaxSPARQL_11_PLUS) ;

        Action action = new Action() {
            @Override
            public void exec(SPARQLParser11Plus parser) throws Exception
            {
                parser.QueryUnit() ;
            }
        } ;
    ...
    public static Template parseTemplate(String string)
    {
        ...
        Action action = new Action() {
            ...
            public void exec(SPARQLParser11Plus parser) throws Exception
            {
                Template t = parser.ConstructTemplatePlus() ;
    ...
    private static void perform(Query query, String string, Action action)
    {
        ...
        SPARQLParser11Plus parser = new SPARQLParser11Plus(in) ;
        ...
        {
            Log.warn(ParserSPARQL11Plus.class, "Unexpected throwable: ",th) ;
