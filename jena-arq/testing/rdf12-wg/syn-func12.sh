...
## 	($SPARQL12)   I=${#GOOD_S12[*]} ; GOOD_S12[$I]=$FN ;;
## 	($SPARQL12U   I=${#GOOD_U12[*]} ; GOOD_U12[$I]=$FN ;;
...
## 	($SPARQL12)  I=${#BAD_S12[*]} ; BAD_S12[$I]=$FN ;;
## 	($SPARQL11U) I=${#BAD_U11[*]} ; BAD_U11[$I]=$FN ;;
## 	($SPARQL12U) I=${#BAD_U12[*]} ; BAD_U12[$I]=$FN ;;
...
##       output "$f" "mf:PositiveSyntaxTest12"
##       done
## 
##     for f in "${BAD_S12[@]}"
##     do
##       output "$f" "mf:NegativeSyntaxTest12"
##       done
## 
##     # ARQ
##     for f in "${GOOD_ARQ[@]}"
...
##     for f in "${GOOD_U12[@]}"
##     do
##       output "$f" "mf:PositiveUpdateSyntaxTest12" ## 
##       done
## 
##     for f in "${BAD_U12[@]}"
##     do
##       output "$f" "mf:NegativeUpdateSyntaxTest12" ##
##       done
## 
##     # ARQ 1.1 Update
##     for f in "${GOOD_ARQU[@]}"
