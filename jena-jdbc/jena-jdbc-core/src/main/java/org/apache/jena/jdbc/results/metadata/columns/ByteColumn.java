...
public class ByteColumn extends NumericColumn {
     ...
     * @param signed Whether the column is signed
     * @throws SQLException
     */
    public ByteColumn(String label, int nullable, boolean signed)
            throws SQLException {
        super(label, Types.TINYINT, nullable, Byte.class, 0, 3, signed);
    }
