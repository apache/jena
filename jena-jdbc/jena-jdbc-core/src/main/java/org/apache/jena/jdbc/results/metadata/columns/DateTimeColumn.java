...
public class DateTimeColumn extends SparqlColumnInfo {
     ...
     * @throws SQLException
     */
    public DateTimeColumn(String label, int nullable) throws SQLException {
        super(label, Types.TIMESTAMP, nullable);
        this.setClassName(Timestamp.class.getCanonicalName());
    }
