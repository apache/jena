...
import static org.seaborne.jena.tdb.base.record.Record.keyGT ;
import static org.seaborne.jena.tdb.base.record.Record.keyLT ;
import static org.seaborne.jena.tdb.base.record.Record.keyNE ;
import static org.seaborne.jena.tdb.index.bplustree.BPlusTreeParams.CheckingNode ;
import static org.seaborne.jena.tdb.index.bplustree.BPlusTreeParams.CheckingTree ;
import static org.seaborne.jena.tdb.index.bplustree.BPlusTreeParams.DumpTree ;
import org.apache.jena.atlas.io.IndentedLineBuffer ;
import org.apache.jena.atlas.io.IndentedWriter ;
import org.seaborne.jena.tdb.base.block.Block ;
import org.seaborne.jena.tdb.base.buffer.PtrBuffer ;
import org.seaborne.jena.tdb.base.buffer.RecordBuffer ;
...
//    public ByteBuffer getBackingByteBuffer()       { return byteBuffer ; }
    ...
    private void split(int idx, BPTreePage y)
    {
        ...
        if ( logging )
        {
            log.debug(format("split >> y=%s  this=%s idx=%d", y.getRefStr(), this.getRefStr(), idx)) ;
            log.debug("split --   "+y) ;
        }
