...
import static org.apache.jena.tdb1.sys.SystemTDB.SizeOfPointer;

import org.apache.jena.atlas.logging.Log ;
import org.apache.jena.tdb1.TDB1Exception;
import org.apache.jena.tdb1.base.file.MetaFile;
...
public class BPlusTreeParams
{
    ...
    public static BPlusTreeParams readMeta(MetaFile mf)
    {
        ...
        } catch (NumberFormatException ex)
        {
            ...
            throw new TDB1Exception("Failed to read metadata") ;
        }
    }
