...
import static org.apache.jena.tdb1.sys.SystemTDB.LenNodeHash;
...
public class NodeLib
{
    ...
    public static void setHash(Hash h, Node n) {
        ...
        switch (nt) {
            ...
            case OTHER :
                throw new TDB1Exception("Attempt to hash something strange: " + n);
        }
        throw new TDB1Exception("NodeType broken: " + n);
    }
