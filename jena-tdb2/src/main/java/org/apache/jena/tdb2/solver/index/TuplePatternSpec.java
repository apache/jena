...
record TuplePatternSpec(
        Node[] tuple,
        JoinKey projection, // JoinKey is a list with unique elements.
        VarMap[] varMaps,
        int[] projs, // array of projected indices - get the var using tuple[proj[i]]
    ...
    public static TuplePatternSpec create(Node[] quad, JoinKey projection) {
